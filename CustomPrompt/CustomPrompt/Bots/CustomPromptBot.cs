...
namespace CustomPrompt
{
    ...
    public class CustomPromptBot : ActivityHandler
    {
        ...
        protected override async Task OnMessageActivityAsync(ITurnContext<IMessageActivity> turnContext, CancellationToken cancellationToken)
        {
            ...
            var profile = await userStateAccessors.GetAsync(turnContext, () => new UserData(), cancellationToken);
        ...
        private static async Task FillOutUserProfileAsync(ConversationFlow flow, UserData profile, ITurnContext turnContext, CancellationToken cancellationToken)
        {
        ...
        private static bool ValidateDate(string input, out string date, out string message)
        {
            ...
            {
                message = "I'm sorry, I could not interpret that as a valid date. Please enter a date at least an hour out.";
            }
